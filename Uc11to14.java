...
public class Uc11to14 { //main class
    ...
    public Uc11to14(String company, int empPerHrWage, int numOFWorkingDays, int totalHourPerMonth) {
    ...
    public static class EmpWageBuilder implements IEmployeeWageCompution {
        ...
        private LinkedList<Uc11to14> employeeWageComputionsList;
        private Map<String,Uc11to14> employeeWageComputionMap;
        ...
        public void addCompanyEmpWage(String company, int empPerHrWage, int numOFWorkingDays, int totalHourPerMonth) {
        	Uc11to14 employeeWageCompution  = new Uc11to14(company, empPerHrWage, numOFWorkingDays, totalHourPerMonth);
        ...
        public void empWageCompute() {
            for (int i = 0; i < employeeWageComputionsList.size(); i++) {
            	Uc11to14 employeeWageCompution = employeeWageComputionsList.get(i);
        ...
        public int empWageCompute(Uc11to14 employeeWageCompution) {
            int empHour = 0;
            int totalEmpHrs = 0;
