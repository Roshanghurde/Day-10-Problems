...
public class Uc10 {
    ...
    public Uc10(String company, int empPerHrWage, int numOFWorkingDays, int totalHourPerMonth) {
    ...
    public static class EmpWageBuilder {
        ...
        private Uc10[] employeeWageComputionArray;

        public EmpWageBuilder() {
            employeeWageComputionArray = new Uc10[5];
        }

        private void addCompanyEmpWage(String company, int empPerHrWage, int numOFWorkingDays, int totalHourPerMonth) {
            employeeWageComputionArray[numofCompanys] = new Uc10(company, empPerHrWage, numOFWorkingDays, totalHourPerMonth);
            numofCompanys++;
        }
        ...
        private int empWageCompute(Uc10 employeeWageCompution) {
            int empHour = 0;
            int totalEmpHrs = 0;
